...
<body>
	...
	<div class="row">
		...
		<div class="col-8">
			...
			<h1 class="text-white ml-5">View Questions</h1>
...
ResultSet rs = stmt.executeQuery("select * from tbl_questions"); %>
<table class="table table-striped table-dark  table-hover" style="margin-left:-4.5em;">

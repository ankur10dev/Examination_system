...
<body>
	...
	<div class="row">
		...
		<div class="col-8">
			...
			<h1 class="text-white ml-5">Registered Students</h1>
	<%
		Connection con = dbConnection.getConnection();
	Statement stmt = con.createStatement();
	ResultSet rs = stmt.executeQuery("select * from tbl_login where usertype='user' ");
	%>
	
	<table  class="table table-striped table-dark" style="margin-left:-2.5em;">
